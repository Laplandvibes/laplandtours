...
// Nykyinen koko ~85 kt. Raja on 15 % alle sen, mutta selvasti yli
// alaskannatun buildin (~54 kt), jotta normaali vaihtelu ei laukaise tata.
const MIN_BYTES = 72_000;
// Luokat jotka tulevat VAIN taman sivuston src/:sta -- ei shared/:sta.
const REQUIRED = ['bg-deeper-night', 'hyphens-auto', 'grid-cols-12'];
