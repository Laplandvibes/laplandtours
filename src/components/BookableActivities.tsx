...
const cards: ActivityCard[] = [
  {
    ...
    labels: {
      ...
      nl: { title: 'Husky-safari', body: 'Bestuur uw eigen team door het bevroren bos, of rijd mee als passagier. Halve dag vanaf Rovaniemi.', meta: 'Rovaniemi · nov–apr · 2–4 u' },
  ...
  },
  {
    ...
    labels: {
      ...
      ko: { title: '스노모빌 투어', body: '얼어붙은 호수와 탁 트인 펠 지대를 가로지릅니다. 단독 운전은 면허 필요, 동승은 부모와 함께 12세부터.', meta: '로바니에미 · 12~4월 · 2~3시간' },
      fr: { title: 'Sortie motoneige', body: 'Sur lacs gelés et fjälls ouverts. Permis pour conduire seul, tandem dès 12 ans avec un parent.', meta: 'Rovaniemi · déc.–avr. · 2–3 h' },
      it: { title: 'Gita in motoslitta', body: 'Su laghi ghiacciati e fjäll aperti. Patente per guidare da soli, tandem dai 12 anni con un genitore.', meta: 'Rovaniemi · dic–apr · 2–3 h' },
      nl: { title: 'Sneeuwscootertocht', body: 'Over bevroren meren en open fjäll. Rijbewijs voor solo, tandem vanaf 12 jaar met een ouder.', meta: 'Rovaniemi · dec–apr · 2–3 u' },
      ...
      'zh-CN': { title: '雪地摩托之旅', body: '驰骋于冰湖与开阔山地之上。单独驾驶需驾照，12 岁起可在家长陪同下双人乘坐。', meta: '罗瓦涅米 · 12–4月 · 2–3 小时' },
    },
  },
  {
  ...
  },
  {
    ...
    labels: {
      ...
      fi: { title: 'Poroajelu', body: 'Rauhallinen ajelu poronhoitajan poron vetämänä, kuten saamelaisperheet ovat kulkeneet sukupolvesta toiseen. Sopii pienimmillekin.', meta: 'Levi · joulu–huhti · 1–2 h' },
      de: { title: 'Rentierschlittenfahrt', body: 'Eine ruhige Fahrt hinter dem Rentier eines Hirten, wie samische Familien seit Generationen reisen. Sanft, schon für Kleinkinder.', meta: 'Levi · Dez–Apr · 1–2 Std.' },
      ...
      fr: { title: 'Traîneau à rennes', body: 'Une balade paisible derrière le renne d’un éleveur, comme les familles samies voyagent depuis des générations. Doux, dès le plus jeune âge.', meta: 'Levi · déc.–avr. · 1–2 h' },
