...
const COPY: Record<CopyLang, {
  ...
  en: {
    ...
    tier: 'Hintaluokka',
    reviewedNote: 'Toimituksellinen arvio · viimeksi tarkistettu toukokuu 2026',
  },
  de: {
    ...
    tier: 'Klasse',
    reviewedNote: 'Redaktionelle Einschätzung · zuletzt überprüft Mai 2026',
  },
  ja: {
    h2Line1: '横並びで比較',
  ...
  ko: {
    ...
    operator: '운영사',
    tier: '가격대',
    reviewedNote: '편집 평가 · 최근 검토 2026년 5월',
  },
  fr: {
    ...
    operator: 'Voyagiste',
    tier: 'Gamme',
    reviewedNote: 'Évaluation éditoriale · dernier examen mai 2026',
  },
  it: {
    ...
    tier: 'Fascia',
    reviewedNote: 'Valutazione editoriale · ultima revisione maggio 2026',
  },
  nl: {
    ...
    tier: 'Klasse',
    reviewedNote: 'Redactionele beoordeling · laatst herzien mei 2026',
  },
  es: {
    ...
    operator: 'Operador',
    tier: 'Gama',
    reviewedNote: 'Valoración editorial · última revisión mayo de 2026',
  },
  'pt-BR': {
    h2Line1: 'Lado a lado',
    ...
    operator: 'Operadora',
    tier: 'Categoria',
    reviewedNote: 'Avaliação editorial · última revisão maio de 2026',
  },
  'zh-CN': {
    h2Line1: '并排对比',
    ...
    operator: '运营商',
    tier: '档位',
    reviewedNote: '编辑评估 · 最近复核 2026 年 5 月',
  },
};
