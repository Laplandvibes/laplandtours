    ...
    rows: [
      {
        ...
        label: '영아',
        summary:
          '아기와 함께 어른들이 이곳을 보러 가는 여행입니다. 영하 기온에서는 일반 유모차가 어렵습니다. 북극 기온에 견디는 아기띠나 유모차 방한 커버(풋머프)를 준비하세요. 대부분의 운영사가 영아에게 무료 또는 할인 요금을 제공합니다.',
        cells: [
          '✓',
          { v: '—', note: '너무 춥고 썰매 진동' },
          { v: '—', note: '영아 불가' },
      ...
      },
      {
        ...
        label: '초등 저학년',
        summary:
          '반나절 허스키와 스노모빌 사파리(동승자)에 충분한 활동량. 늦은 저녁 출발이 괜찮다면 오로라 헌트도 가능합니다. 레비, 윌래스, 사리셀카에서의 스키 프로그램을 고려할 만해집니다.',
        cells: [
          '✓',
          { v: '동승자', note: '반나절' },
          { v: '동승자', note: '반나절' },
      ...
      },
      {
        ...
        label: '독립적 행동 가능',
        summary:
          '대부분의 액티비티에서 성인으로 대우받습니다. 운전면허 보유 시 단독 스노모빌 운전(렌털 업체는 보통 18세 이상), 더 긴 허스키 주행, 빙벽 등반, 여러 날에 걸친 툰드라 구릉(펠) 트레킹 가능. 오로라 사진 워크숍 역시 이 정도의 성숙도가 필요합니다.',
        cells: [
          '✓',
          '✓',
          { v: '단독', note: '운전면허 필요' },
