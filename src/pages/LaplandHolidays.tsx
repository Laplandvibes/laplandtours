    ...
    <>
      ...
      <section className="bg-deeper-night py-16 sm:py-20">
        <div className="max-w-[900px] mx-auto px-6 sm:px-10 text-center">
          ...
          <Link
            to={to('/design-tour')}
            className="lv-tap mt-8 inline-flex items-center gap-2 text-snow border-b border-snow/40 hover:border-vibe-pink hover:text-vibe-pink pb-1 font-body font-medium transition-colors"
          >
            {c.noneCta}
          </Link>
        </div>
