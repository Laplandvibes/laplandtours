    ...
    sections: [
      {
        ...
        title: '가는 방법',
        body:
          '로바니에미(RVN), 키틸래(KTT), 이발로(IVL)로는 Finnair로 헬싱키 경유 후 1시간 국내선을 이용하거나 VR 야간 침대열차(12시간, 침대칸)를 탈 수 있습니다.',
      },
      {
        n: '02',
        title: '기후 및 짐 싸기',
      ...
      },
      {
        ...
        title: '현지 이동',
        body:
          '대부분의 패키지에는 모든 픽업이 포함됩니다. 독립적으로 연장하려면: 헬싱키 ↔ 로바니에미/키틸래/이발로 국내선, VR 헬싱키–로바니에미 야간 침대열차, 또는 라플란드 세 공항에서의 렌터카 자유 운전을 이용할 수 있습니다.',
      },
      {
        n: '06',
        title: '건강과 안전',
