...
const L10N_LOCAL: Record<string, Partial<Record<OperatorLang, OperatorL10n>>> = {
  'lapland-safaris': {
    ...
    'zh-CN': {
      ...
      tierLabel: '全项目活动运营商',
      whatTheyDoWell:
        '自 1982 年运营至今，在罗瓦涅米、莱维、于拉斯、萨利色尔卡和卢奥斯托设有基地，拥有芬兰拉普兰最广的活动种类：哈士奇与驯鹿农场、雪地摩托、极光团、雪鞋行走以及装备租赁。向导植根于当地与萨米人的知识，公司还获得芬兰国家旅游安全奖。',
      whatTheyDont:
  ...
  safartica: {
    ...
    'zh-CN': {
      ...
      tierLabel: '活动与住宿',
      whatTheyDoWell:
        '总部位于罗瓦涅米，在于拉斯、莱维和萨利色尔卡设有基地。哈士奇、驯鹿与雪地摩托、极光追寻、冰钓和冬泳——以及全球首创的电动雪地摩托（eSled）团。还经营自有小木屋和荒野住宿，可组合“住宿+活动”套餐。',
      whatTheyDont:
  ...
  harriniva: {
    ...
    ko: {
      ...
      whatTheyDoWell:
        '1973년부터 이어온 무오니오의 가족 기업으로 지금은 3대째이며, 자체 대형 허스키 견사와 여러 날에 걸친 사파리가 중심입니다. 하리니바, 예리스 레이크사이드, 토라시에피 순록 농장 등 세 곳의 리조트를 직영 레스토랑과 함께 운영하며, 여름에는 래프팅과 하이킹도 진행합니다. 키틸래 공항과 콜라리 기차역에서 이동 서비스를 제공합니다.',
      whatTheyDont:
        '무오니오는 외진 곳으로 키틸래 공항에서 약 1.5시간 거리입니다. 로바니에미 당일 투어 업체가 아닙니다.',
    },
    fr: {
