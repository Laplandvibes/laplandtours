...
const STRINGS: Record<string, {
  ...
  'pt-BR': { headline: 'A Lapônia no seu e-mail', sub: 'Estações, lugares e quando reservar, das minhas próprias viagens pela Lapônia.', placeholder: 'Seu e-mail', submit: 'Quero participar!', loading: 'Inscrevendo…', success: 'Você está dentro! O e-mail de boas-vindas está a caminho.', already: 'Sua inscrição já estava ativa — nada mais a fazer.', trust: 'Apenas quando vale a pena destacar. Cancele a qualquer momento.', error: 'Falha na inscrição. Tente novamente.' , consent: `Aceito receber a newsletter da LaplandVibes no e-mail informado, com dicas de viagem, informações de temporada e ofertas. Tenho 18 anos ou mais.`, privacy: `Política de Privacidade` },
  'zh-CN': { headline: '拉普兰，直达你的邮箱', sub: '季节、去处与预订时机——来自我自己的拉普兰旅程。', placeholder: '您的邮箱地址', submit: '算我一个！', loading: '订阅中…', success: '欢迎加入！欢迎邮件正在路上。', already: '您已订阅——无需再操作。', trust: '只在真正值得通知时发送。随时可取消。', error: '订阅失败。请重试。' , consent: `我同意 LaplandVibes 向我填写的邮箱发送订阅邮件，内容包括拉普兰旅行建议、季节资讯和优惠信息，并确认本人已年满18周岁。`, privacy: `隐私政策` },
  ko: { headline: '라플란드를 메일함으로', sub: '시즌, 장소, 예약 타이밍 — 제가 직접 다닌 라플란드 여행에서.', placeholder: '이메일 주소', submit: '함께할게요!', loading: '구독 중…', success: '환영합니다! 환영 이메일이 가고 있어요.', already: '이미 구독 중이셨습니다 — 더 하실 일은 없어요.', trust: '정말 가치 있는 소식만 보내드립니다. 언제든 해지 가능.', error: '구독 실패. 다시 시도해 주세요.' , consent: `입력한 이메일 주소로 LaplandVibes가 보내는 여행 팁·시즌 정보·프로모션 소식 뉴스레터 수신에 동의하며, 만 18세 이상임을 확인합니다.`, privacy: `개인정보처리방침` },
