...
const STRINGS: Record<string, {
  ...
  it: { headline: 'La Lapponia nella tua casella', sub: 'Stagioni, posti e tempi di prenotazione, dai miei viaggi in Lapponia.', placeholder: 'Il tuo indirizzo e-mail', submit: 'Ci sto!', loading: 'Iscrizione…', success: 'Ci siamo quasi: conferma l\'iscrizione dall\'e-mail che ti abbiamo appena inviato.', already: 'La tua iscrizione era già attiva — non serve altro.', trust: 'Solo quando c\'è qualcosa che vale davvero. Disiscrizione in qualsiasi momento.', error: 'Iscrizione fallita. Riprova.' , consent: `Sì, desidero ricevere la newsletter di LaplandVibes (consigli di viaggio, novità stagionali e offerte) all'indirizzo indicato. Ho almeno 18 anni.`, privacy: `Informativa sulla privacy` },
