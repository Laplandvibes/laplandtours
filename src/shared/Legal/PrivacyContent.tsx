...
const COPY: Record<Lang, {
  ...
  en: {
    ...
    s3Items: [
      ...
      { strong: 'Affiliate cookies', body: 'Placed when you click affiliate links (e.g. Adtraction or Travelpayouts tracking). These help us attribute referral commissions.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts and Trip.com, affiliate link tracking when you click booking or partner links',
    ...
    s8Body2: 'We participate in affiliate programmes through the Adtraction and Travelpayouts networks and in the Trip.com partner programme; partners include Sembo, Lomarengas, Trip.com and EconomyBookings. When you click an affiliate link and make a purchase or booking, we may receive a commission at no additional cost to you.',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Sweden, EU; Travelpayouts and Trip.com, international): transfers outside the EU/EEA are covered by Standard Contractual Clauses.' },
    ...
    s3Items: [
      ...
      { strong: 'Kumppanievästeet', body: 'asetetaan, kun klikkaat kumppanilinkkiä (esim. Adtraction- tai Travelpayouts-seuranta). Näiden avulla varauspalvelut kohdistavat komission oikealle lähteelle.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts ja Trip.com, kumppanilinkkien klikkauksen seuranta varaus- ja kumppanilinkeille',
    ...
    s8Body2: 'Osallistumme kumppaniohjelmiin Adtraction- ja Travelpayouts-verkostojen sekä Trip.comin kumppaniohjelman kautta; kumppaneitamme ovat mm. Sembo, Lomarengas, Trip.com ja EconomyBookings. Kun klikkaat kumppanilinkkiä ja teet ostoksen tai varauksen, voimme saada pienen komission ilman lisäkustannuksia sinulle.',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Ruotsi, EU; Travelpayouts ja Trip.com, kansainväliset): EU/ETA-alueen ulkopuoliset siirrot on katettu vakiosopimuslausekkein (SCC).' },
  ...
  de: {
    ...
    s3Items: [
      ...
      { strong: 'Partner-Cookies', body: 'werden gesetzt, wenn Sie auf Partnerlinks klicken (z. B. Adtraction- oder Travelpayouts-Tracking). So lassen sich Provisionen korrekt zuordnen.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts und Trip.com, Tracking von Partnerlinks bei Klicks auf Buchungs- und Partnerlinks',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Schweden, EU; Travelpayouts und Trip.com, international): Übermittlungen außerhalb der EU/des EWR sind durch Standardvertragsklauseln abgedeckt.' },
  ...
  ja: {
    ...
    s3Items: [
      ...
      { strong: 'アフィリエイトクッキー', body: 'アフィリエイトリンク(例: Adtraction / Travelpayouts のトラッキング)をクリックしたときに設定されます。紹介料の帰属に役立ちます。' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction、Travelpayouts、Trip.com, 予約・パートナーリンクのクリック追跡',
      'Resend, ニュースレターの配信',
    ...
    s8Body2: 'Adtraction と Travelpayouts のネットワーク、および Trip.com のパートナープログラムを通じてアフィリエイトプログラムに参加しています(パートナー例: Sembo、Lomarengas、Trip.com、EconomyBookings)。アフィリエイトリンクからご予約・ご購入された場合、お客様には追加費用なしで当社が手数料を受け取ることがあります。',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB(スウェーデン、EU)、Travelpayouts と Trip.com(国際)):EU/EEA 域外への移転は標準契約条項(SCC)の対象です。' },
  ...
  es: {
    ...
    s3Items: [
      ...
      { strong: 'Cookies de afiliados', body: 'se establecen cuando hace clic en enlaces de afiliados (por ejemplo, seguimiento de Adtraction o Travelpayouts). Permiten atribuir las comisiones por referencia.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts y Trip.com, seguimiento de clics en enlaces de reserva y de afiliados',
    ...
    s8Body2: 'Participamos en programas de afiliación a través de las redes Adtraction y Travelpayouts y del programa de socios de Trip.com; entre nuestros socios están Sembo, Lomarengas, Trip.com y EconomyBookings. Cuando hace clic en un enlace de afiliado y realiza una compra o reserva, podemos recibir una comisión sin coste adicional para usted.',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Suecia, UE; Travelpayouts y Trip.com, internacionales): las transferencias fuera de la UE/EEE están amparadas por Cláusulas Contractuales Tipo.' },
  ...
  'pt-BR': {
    ...
    s3Items: [
      ...
      { strong: 'Cookies de afiliados', body: 'definidos quando você clica em links de afiliados (por exemplo, rastreamento da Adtraction ou da Travelpayouts). Ajudam a atribuir as comissões de indicação.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts e Trip.com, rastreamento de cliques em links de reserva e afiliados',
    ...
    s8Body2: 'Participamos de programas de afiliados por meio das redes Adtraction e Travelpayouts e do programa de parceiros da Trip.com; entre os parceiros estão Sembo, Lomarengas, Trip.com e EconomyBookings. Quando você clica em um link de afiliado e faz uma compra ou reserva, podemos receber uma comissão sem custo adicional para você.',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Suécia, UE; Travelpayouts e Trip.com, internacionais): transferências para fora da UE/EEE são cobertas pelas Cláusulas Contratuais Padrão.' },
  ...
  'zh-CN': {
    ...
    s3Items: [
      ...
      { strong: '联盟 cookie', body: '当您点击联盟链接(例如 Adtraction 或 Travelpayouts 追踪)时设置,用于归因推荐佣金。' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction、Travelpayouts 与 Trip.com, 点击预订与合作伙伴链接的追踪',
      'Resend, 电子简报邮件发送',
      'Supabase, 后端数据库服务',
      'Cloudflare, 托管与 CDN',
    ],
    ...
    s8Body2: '我们通过 Adtraction 和 Travelpayouts 网络以及 Trip.com 合作伙伴计划参与联盟计划,合作伙伴包括 Sembo、Lomarengas、Trip.com 和 EconomyBookings。当您点击联盟链接并完成购买或预订时,我们可能获得佣金,而您无需承担任何额外费用。',
    s8aTitle: '8a. 跨境数据传输',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB,瑞典,欧盟;Travelpayouts 与 Trip.com,国际):欧盟/欧洲经济区以外的传输受标准合同条款(SCC)保护。' },
  ...
  ko: {
    ...
    s3Items: [
      ...
      { strong: '제휴 쿠키', body: '제휴 링크 클릭 시 설정(예: Adtraction, Travelpayouts 추적). 추천 수수료 귀속에 사용됩니다.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts, Trip.com, 예약·파트너 링크 클릭 추적',
      'Resend, 뉴스레터 이메일 발송',
    ...
    s8Body2: '당사는 Adtraction 및 Travelpayouts 네트워크와 Trip.com 파트너 프로그램을 통해 제휴 프로그램에 참여합니다. 파트너로는 Sembo, Lomarengas, Trip.com, EconomyBookings 등이 있습니다. 제휴 링크를 통해 구매 또는 예약을 하시면 추가 비용 없이 당사가 수수료를 받을 수 있습니다.',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, 스웨덴, EU; Travelpayouts 및 Trip.com, 국제): EU/EEA 역외 이전에는 표준계약조항(SCC)이 적용됩니다.' },
  ...
  fr: {
    ...
    s3Items: [
      ...
      { strong: 'Cookies d\'affiliation', body: 'déposés lorsque vous cliquez sur un lien d\'affiliation (par exemple suivi Adtraction ou Travelpayouts). Ils permettent d\'attribuer les commissions de référencement.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts et Trip.com, suivi des clics sur les liens de réservation et d\'affiliation',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Suède, UE ; Travelpayouts et Trip.com, internationaux) : les transferts hors UE/EEE sont couverts par les clauses contractuelles types.' },
  ...
  it: {
    ...
    s3Items: [
      ...
      { strong: 'Cookie di affiliazione', body: 'impostati quando Lei clicca su link di affiliazione (ad esempio tracciamento Adtraction o Travelpayouts). Permettono di attribuire le commissioni di referral.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts e Trip.com, tracciamento dei clic su link di prenotazione e affiliazione',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Svezia, UE; Travelpayouts e Trip.com, internazionali): i trasferimenti al di fuori di UE/SEE sono coperti dalle clausole contrattuali tipo.' },
  ...
  nl: {
    ...
    s3Items: [
      ...
      { strong: 'Affiliate cookies', body: 'geplaatst wanneer u op affiliate links klikt (bijv. Adtraction- of Travelpayouts-tracking). Deze helpen ons verwijzingscommissies toe te wijzen.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts en Trip.com, tracking van klikken op boekings- en affiliate links',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Zweden, EU; Travelpayouts en Trip.com, internationaal): doorgiften buiten de EU/EER worden gedekt door de standaardcontractbepalingen.' },
  ...
  sv: {
    ...
    s3Items: [
      ...
      { strong: 'Affiliatecookies', body: 'placeras när du klickar på affiliatelänkar (t.ex. Adtraction- eller Travelpayouts-spårning). De hjälper oss att attribuera hänvisningsprovisioner.' },
    ],
    ...
    s7Items: [
      ...
      'Adtraction, Travelpayouts och Trip.com, spårning av affiliatelänkar när du klickar på boknings- eller partnerlänkar',
    ...
    s8Body2: 'Vi deltar i affiliateprogram via nätverken Adtraction och Travelpayouts samt i Trip.coms partnerprogram; bland våra partner finns Sembo, Lomarengas, Trip.com och EconomyBookings. När du klickar på en affiliatelänk och gör ett köp eller en bokning kan vi få en provision utan extra kostnad för dig.',
    ...
    s8aItems: [
      ...
      { strong: 'Adtraction / Travelpayouts / Trip.com', body: '(Adtraction AB, Sverige, EU; Travelpayouts och Trip.com, internationella): överföringar utanför EU/EES omfattas av standardavtalsklausuler.' },
